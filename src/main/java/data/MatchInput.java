...
public class MatchInput
{
    ...
    public String getNuetral_venue() {
        return nuetral_venue;
    }

    public void setNuetral_venue(String nuetral_venue) {
        this.nuetral_venue = nuetral_venue;
    }
